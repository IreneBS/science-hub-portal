...
const Results = () => {
  return (
    <div className="container mx-auto px-6 py-10">
      ...
      >
        <h1 className="section-header">Resultados de Investigación</h1>
      ...
      >
        <Card className="glass-panel">
          <CardHeader>
            ...
            <CardDescription>Acceda a nuestros últimos informes y publicaciones científicas</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {[
                { title: "Informe trimestral Q1 2024", date: "Marzo 2024", type: "PDF", size: "2.4 MB" },
                { title: "Artículo: Nuevos enfoques metodológicos", date: "Febrero 2024", type: "PDF", size: "1.8 MB" },
                { title: "Datos experimentales serie A-234", date: "Enero 2024", type: "XLSX", size: "5.2 MB" },
                { title: "Publicación en Revista de Ciencias Aplicadas", date: "Diciembre 2023", type: "PDF", size: "3.5 MB" },
              ].map((doc, index) => (
