        ...
        <Card className="glass-panel p-6 mb-8">
          ...
          <CardContent className="p-0">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              Sed euismod, nisl nec ultricies ultricies, nunc nisl ultricies nunc, 
              quis ultricies nisl nisl nec ultricies. Sed euismod, nisl nec ultricies ultricies, 
              nunc nisl ultricies nunc, quis ultricies nisl nisl nec ultricies.
            </p>
            <p className="text-muted-foreground">
              Nulla facilisi. Sed euismod, nisl nec ultricies ultricies, nunc nisl ultricies nunc, 
              quis ultricies nisl nisl nec ultricies. Sed euismod, nisl nec ultricies ultricies, 
              nunc nisl ultricies nunc, quis ultricies nisl nisl nec ultricies.
            </p>
          </CardContent>
